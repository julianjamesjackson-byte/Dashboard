...
const facilityData = {
  kpis: {
    ...
    openRate: '0000%',
    replies: '0000',
    positiveReplyRate: '0000%',
    meetingsBooked: '0000',
    bounceRate: '0000%',
  },
  trendData: [
    { name: 'Mon', emails: 0, replies: 0 },
    { name: 'Tue', emails: 0, replies: 0 },
    { name: 'Wed', emails: 0, replies: 0 },
    { name: 'Thu', emails: 0, replies: 0 },
    { name: 'Fri', emails: 0, replies: 0 },
    { name: 'Sat', emails: 0, replies: 0 },
    { name: 'Sun', emails: 0, replies: 0 },
    { name: 'Mon', emails: 0, replies: 0 },
    { name: 'Tue', emails: 0, replies: 0 },
    { name: 'Wed', emails: 0, replies: 0 },
    { name: 'Thu', emails: 0, replies: 0 },
  ...
  sentimentData: [
    { name: 'Interested/Booked', value: 0, color: '#10b981' },
    { name: 'Neutral/Inquiry', value: 0, color: '#3b82f6' },
    { name: 'Out of Office', value: 0, color: '#f59e0b' },
    { name: 'Not Interested', value: 0, color: '#ef4444' },
  ],
  feed: []
};
